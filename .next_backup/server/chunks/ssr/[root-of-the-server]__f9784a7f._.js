...
function ComponentWrapper({ children, component, path, isSelected, onSelect, onDelete, onAddComponent, onMoveComponent }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            isDraggedOver && type !== 'Section' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
function EditorClient({ pageData }) {
        ...
        const updateRecursively = (components)=>{
            for(let i = 0; i < components.length; i++){
                ...
                if (components[i].children) {
                    if (updateRecursively(components[i].children)) return true;
                }
            }
            return false;
        };
    ...
    const deleteComponent = (id)=>{
        ...
        const deleteRecursively = (components)=>{
    ...
    const handleAddComponent = (type, parentId, targetId = null, position = 'top')=>{
    ...
    const handleMoveComponent = (draggedId, targetId, parentId, position)=>{
        if (draggedId === targetId) return;
        let componentToMove = null;
        // Function to recursively find and remove a component
        const removeComponent = (items, id)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f9784a7f._.js.map