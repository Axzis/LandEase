        ...
        <main className="flex-grow">
          <section className="py-24 md:py-32 lg:py-40 bg-background text-center">
            <div className="container mx-auto px-4">
              <h1 data-aos="fade-up" className="text-4xl md:text-6xl font-bold tracking-tighter text-foreground mb-6 text-balance">
                Build Stunning Landing Pages, Effortlessly.
              </h1>
              <p data-aos="fade-up" data-aos-delay="100" className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-10 text-balance">
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {features.map((feature, i) => (
                  <Card key={feature.title} data-aos="fade-up" data-aos-delay={i * 100} className="bg-card shadow-sm hover:shadow-xl transition-all duration-300 ease-in-out hover:-translate-y-2 flex flex-col items-center text-center p-6">
          ...
          <section id="how-it-works" className="py-20 md:py-24 bg-background">
            <div className="container mx-auto px-4">
              ...
              <div className="relative">
                  <div className="absolute top-1/2 left-0 w-full h-0.5 bg-border -translate-y-1/2 hidden md:block" aria-hidden="true" data-aos="zoom-in"></div>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
                  {howItWorks.map((step, i) => (
                      <div key={step.step} className="flex flex-col items-center text-center" data-aos="fade-up" data-aos-delay={i * 100}>
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="flex justify-center items-stretch gap-8 flex-wrap">
                {pricingPlans.map((plan, i) => (
                  <div key={plan.title} data-aos="fade-up" data-aos-delay={i * 100} className="w-full max-w-sm">
                    <Card className={`h-full flex flex-col transition-all duration-300 ease-in-out hover:shadow-xl hover:-translate-y-2 ${plan.popular ? 'border-primary shadow-lg' : 'shadow-sm'}`}>
